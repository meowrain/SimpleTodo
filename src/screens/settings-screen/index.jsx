...
export default function SettingsScreen({ navigation }) {
  ...
  return (
    <View>
      <View style={{ flexDirection: 'row', alignItems: 'center', justifyContent: 'center',marginTop: 10 }}><Octicons name="gear" size={22} color={isDarkModeOn ? 'white' : 'black'} /><List.Section title="设置" titleStyle={{ fontSize: 18 }}></List.Section></View>
      <List.Section>
